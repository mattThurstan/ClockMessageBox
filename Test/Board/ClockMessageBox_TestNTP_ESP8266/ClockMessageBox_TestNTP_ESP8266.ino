/*
    'ClockMessageBox_TestNTP_ESP8266' by Thurstan. Wifi connected box with LED Matrix showing clock and messages.
...
#include <MT_DS1307RTC.h>                 // https://github.com/mattThurstan/MT_DS1307RTC - edit of PaulStoffregen DS3231 Clock (with basic temperature)
#include <time.h>
#include <ArduinoJson.h>                  // https://github.com/bblanchon/ArduinoJson
#include <PubSubClient.h>                 // https://github.com/knolleary/pubsubclient

/*----------------------------system----------------------------*/
const String _progName = "ClockMessageBox_TestNTP_ESP8266";
const String _progVers = "1.6";           // Test NTP
